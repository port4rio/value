...
app.post('/api/ai/diagnosis', async (req, res) => {
  try {
    ...
    const prompt = `
あなたは日本株のバリュー投資専門アナリストです。
毎週土曜日に実施される定期診断として、以下の銘柄のファンダメンタルズ情報を精査し、個人投資家が中長期で安心・納得して保有できるかを厳正に診断してください。
...
2. "valuation_appeal": 投資妙味と割安要因（低PBR/PERや利回りの理由、下値の堅さ）
3. "dividend_sustainability": 配当の持続性と株主還元方針（減配リスクの低さ、DOE導入や自社株買いの積極性など）
4. "catalyst": PBR是正や株価上昇カタリスト（東証要請対応、資本効率向上、政策保有株売却、海外展開など）
5. "risks": 注意すべきリスク要因（市況悪化、顧客集中、円高/円安、原材料高などの下振れリスク）
